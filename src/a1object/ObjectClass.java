...
查看源代码的方式：
	方式一： 按住command键，单击你需要看的源代码.
	
	方式二：把光标移动到你需要查看代码处按下F3(mac下不清楚).
...
public class ObjectClass {
	...
	public static void main(String[] args) {
		...
		/*
		 * java.lang.Object@18b3364 返回的字符串表示： 完整类名 + @ + 对象的哈希码（对象的内存地址）
		 * System.out.println(o);
		 * 
		 * //疑问：为什么直接输出一个对象的时候和输出对象的toString方法返回的字符串结果是一样的呢？
		 * 
		 * 通过查看源代码得知，直接输出一个对象 的时候，实际上在println方法内部会调用这个
		 * 对象的的toString方法，把把toString方法返回的内容输出。
		 * 
		 * Person p1 = new Person(110,"狗娃"); System.out.println("p1:"+p1);
		 * //如果我们能够输出一个p对象的时候，输出的格式： 编号：110 姓名： 狗娃.. Person p2 = new
		 * Person(112,"狗剩"); System.out.println("p2:"+p2);
		 */
		...
		System.out.println("oc的哈西吗：" + oc.hashCode());// 说明Object 是个父类
