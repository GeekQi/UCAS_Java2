...
wait与notify方法要注意的事项：
	1. wait方法与notify方法是属于Object对象的。//因为锁对象是任意的对象，所以不能在thread对象
	2. wait方法与notify方法必须要在同步代码块或者是同步函数中才能 使用。//如果不存在同步代码块，就没有锁的存在
	3. wait方法与notify方法必需要由锁对象调用。//要以锁对象为标示符建立线程池 
